...
---
## ➡️ The project is divided in three parts, please check them in this respective order : 

 * ⇢ <ins>**Dashboard Streamlit project**</ins> : delay of user analysis dashboard with Streamlit 👩‍🏫
    - https://doshdyndss-app-getaround-4bf17df654cb.herokuapp.com/

 * ⇢ <ins>**MLflow_monitoring_project**</ins>: testing and monitoring models thanks to MLflow tool 👩🏽‍💻
 ...
 * ⇢ <ins>**Prices_Prediction_API_project**</ins> :  API where you can play with by changing car characteristics and predict rental prices per day 📈
...
- An **documented online API** on Heroku server (or any other provider you choose) containing at least **one `/predict` endpoint** that respects the technical description above.
